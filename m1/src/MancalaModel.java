...
public class MancalaModel
{
   ...
   public void doTurn(char player, int pitNumber)
   {
                ...
                if(player=='a'){     //player A will pick from anyone of a[] pits
                    ...
                    //int BpitNumber = obj.bestPitFinder(new State(a,b,mancalaA,mancalaB),true);
                ...
                //Code remaining: if last stone in mancala get free turn - this needs to be cleared as this may break min max alternation
                changeEvent(); 
